        ...
        IEnumerator WarpText()
        {
            ...
            while (true)
            {
                ...
                for (int i = 0; i < characterCount; i++)
                {
                    ...
                    // Get the index of the mesh used by this player.
                    int materialIndex = textInfo.characterInfo[i].materialReferenceIndex;

                    vertices = textInfo.meshInfo[materialIndex].vertices;

                    // Compute the baseline mid point for each player
                    ...
                    // Compute the angle of rotation for each player based on the animation curve
